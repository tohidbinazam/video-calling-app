          ...
          <Col md='8'>
            ...
            <Card className='mb-3'>
              ...
              <Card.Footer className='d-flex justify-content-between'>
                <div className='w-25 text-start'>
                  ...
                  <Button size='lg' onClick={handleCam} variant={color.cam}>
                    {' '}
                    <BsFillCameraVideoFill /> Cam{' '}
                  </Button>
                </div>
                <div className='w-50 text-center'>
                  <Button size='lg' onClick={handleScreen} variant={color.scr}>
                    {' '}
                    <MdScreenShare /> Screen share{' '}
                  </Button>
                </div>
            ...
            <Card>
              <Card.Body className='d-flex justify-content-between'>
                {toCall.status && (
                  <h1>
                    You Call <b className='text-success'>{toCall.name}</b>
                  </h1>
                )}
                ...
                {call.isCalling && (
                  <>
                    <h1>
                      <b className='text-success'>{caller.name}</b> is
                      calling...
                    </h1>
                    <div>
                      <Button
                ...
                {call.isAccepted && (
                  <>
                    <h1>
                      Connected with{' '}
                      <b className='text-success'>{caller.name}</b>
                    </h1>
                    <div>
                      <Button
                        variant='danger'
                          ...
                          <Card.Body className='fnf'>
                            ...
                            <div className='status'>
                              {data.callId ? (
                                <Button
                                  onClick={() =>
                                    handleCall(data.callId, data.name)
                                  }
                                  size='lg'
                                  variant='dark'
                                >
                                ...
                                <Button
                                  onClick={() => handleCall(data.callId)}
                                  size='lg'
                                  variant='dark'
                                  disabled
                                >
